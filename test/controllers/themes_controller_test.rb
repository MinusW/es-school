...
class ThemesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create theme" do
    assert_difference("Theme.count") do
      post themes_url, params: { theme: { is_archived: @theme.is_archived, module_description: @theme.module_description, module_name: @theme.module_name } }
    end
  ...
  test "should update theme" do
    patch theme_url(@theme), params: { theme: { is_archived: @theme.is_archived, module_description: @theme.module_description, module_name: @theme.module_name } }
