class ThemesController < ApplicationController
  ...
  def destroy
    ...
    @theme.update(is_archived: true)

    respond_to do |format|
      format.html { redirect_to themes_url, notice: "Theme was successfully archived." }
  ...
  private
    ...
    def theme_params
      params.require(:theme).permit(:module_name, :module_description, :is_archived)
    end
end
